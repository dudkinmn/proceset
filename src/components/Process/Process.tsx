...
import { TProcessProps } from "./Process.types";
import {
  getHHMM,
  getPercent,
  getDDMMYYYY,
  ...
  return (
    <div className={styles.process}>
      <div className={styles.processHeader}>
        ...
        <label className={styles.linkToMap}>
          На карту процесса
          <Icon.ArrowRight />
        </label>
      </div>
        ...
        <div className={styles.infoColumn}>
          <div className={styles.infoBlockFirst}>
            <div className={styles.infoBlockMainData}>
              <Icon.CountRepeat />
              <span className={styles.dataNumberOfExecutions}>
        ...
        <div className={styles.infoColumn}>
          <div className={styles.infoBlockSecondToFifth}>
            <div className={styles.infoBlockMainData}>
              ...
              <span className={styles.dataOth}>
                {getHHMM(process.averageLeadTime)}
              </span>
            </div>
          ...
          <div className={styles.infoBlockSecondToFifth}>
            <div className={styles.infoBlockMainData}>
              ...
              <span className={styles.dataOth}>
                {getHHMM(process.averageActiveTime) +
                  getPercent(
        ...
        <div className={styles.infoColumn}>
          ...
          <div className={styles.infoBlockSecondToFifth}>
            <div className={styles.infoBlockMainData}>
              <Icon.CountScenaries />
              <span className={styles.dataOth}>
                {getNumberWithText(process.numberOfScenarios, "сценарий")}
              </span>
            </div>
